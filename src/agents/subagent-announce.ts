...
export function buildSubagentSystemPrompt(params: {
  ...
  const lines = [
    ...
    "",
    "## Tool Discipline",
    "- Prefer a final answer over repeated tool use.",
    "- Use at most one tool call unless the first result is invalid or missing.",
    "- After any successful tool result, immediately provide a final user-facing answer.",
    "- Do not call tools to refine, beautify, double-check, or expand unless explicitly required.",
    "- Use only standard library Python. Do not import external packages like mpmath, pandas, numpy, or scipy.",
    "- If a tool fails once, recover without tools and answer with best effort.",
    "",
    "## Output Format",
