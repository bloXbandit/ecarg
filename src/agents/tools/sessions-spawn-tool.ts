...
export function createSessionsSpawnTool(opts?: {
  ...
  return {
    ...
    execute: async (_toolCallId, args) => {
      ...
      const thinkingOverrideRaw =
        readStringParam(params, "thinking") ??
        readStringParam(params, "reasoningEffort") ??
        readStringParam(params, "reasoning.effort");
      const cleanup =
        ...
        try {
          await callGateway({
            ...
            params: {
              key: childSessionKey,
              model: resolvedModel,
              ...(thinkingOverride ? { reasoning: { effort: thinkingOverride } } : {}),
            },
            timeoutMs: 10_000,
          });
          modelApplied = true;
